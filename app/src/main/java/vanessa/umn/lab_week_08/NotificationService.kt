...
class NotificationService : Service() {
    ...
    private fun startForegroundServiceProperly(): NotificationCompat.Builder {
    ...
    String) =
        NotificationCompat.Builder(this, channelId)
            ...
            .setOngoing(true)
            //Make sure the notification actually shows up
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        notificationBuilder = startForegroundServiceProperly()
